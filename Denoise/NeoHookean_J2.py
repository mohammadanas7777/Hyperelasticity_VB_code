...
for m in range(0,len(loadsteps)):  
    ...
    print('.')
    print('.')
    df = pd.read_csv("../FEM_data/NeoHookean_J2/"+str(loadsteps[m])+"/coordinates_and_disp.csv") 
    ...
    df2.to_csv("../FEM_data/NeoHookean_J2/"+str(loadsteps[m])+"/coordinates_and_disp.csv",
