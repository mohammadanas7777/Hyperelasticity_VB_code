...
for j in range(0,len(loadsteps)):
    ...
    isExist = os.path.exists("/Users/mohammad.anas7777gmail.com/Downloads/EUCLID_SS_Gibbs/Plate_without_hole/FEM_data/HainesWilson/"+str(loadsteps[j]))
    
    if not isExist:
    # Create a new directory because it does not exist
       os.makedirs("/Users/mohammad.anas7777gmail.com/Downloads/EUCLID_SS_Gibbs/Plate_without_hole/FEM_data/HainesWilson/"+str(loadsteps[j]))
    ...
    df.to_csv("/Users/mohammad.anas7777gmail.com/Downloads/EUCLID_SS_Gibbs/Plate_without_hole/FEM_data/HainesWilson/"+str(loadsteps[j])+"/connectivity.csv",
    ...
    W = 0.5*(I1_bar -3) + 1.0*(I2_bar - 3) + 0.7*(I1_bar -3)*(I2_bar -3) + 0.2*(I1_bar - 3)**3 + 1.5*((J-1)**2)
    ...
    df.to_csv("/Users/mohammad.anas7777gmail.com/Downloads/EUCLID_SS_Gibbs/Plate_without_hole/FEM_data/HainesWilson/"+str(loadsteps[j])+"/coordinates_and_disp.csv",
    ...
    df.to_csv("/Users/mohammad.anas7777gmail.com/Downloads/EUCLID_SS_Gibbs/Plate_without_hole/FEM_data/HainesWilson/"+str(loadsteps[j])+"/reactions.csv",
    ...
    #Define function
    Wa = 0.5*(i1bar -3) + 1.0*(i2bar - 3) + 0.7*(i1bar -3)*(i2bar -3) + 0.2*(i1bar - 3)**3 + 1.5*((ja-1)**2)
